        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form:form action="menu-save" modelAttribute="food" role="form"/>
               <form:hidden path="id"/>
                <div class="card-body">
                  <div class="form-group">
                    <label>Food name</label>
                    <form:input type="text" class="form-control" placeholder="Enter food name" path="name"/>
                  	<form:errors path="name" cssClass="text-danger"/>
                  </div>
                
                 <div class="form-group"> 
                     <label>Food category</label> 
                     <form:input type="text" class="form-control" placeholder="Enter food category" path="category"/> 
                   	<form:errors path="category" cssClass="text-danger"/> 
                 </div> 
                  
                  <div class="form-group">
                    <label>Food price</label>
                    <form:input type="text" class="form-control" placeholder="Enter food price" path="price"/>
                ...
                <div class="form-group">
                    ...
                    <form:input type="text" class="form-control" placeholder="Enter food description" path="description"/>
                ...
                <div class="card-footer">
                  ...
                  <a href="menu-update-cancel" class="btn btn-outline-secondary">Cancel</a>
 				</div>
