  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="reservation-list" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="reservation-list">Home</a></li>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <h4 align="right"><a href="menu-form"><button style="border-bottom-color:black; background: aqua;" class="button1">Add food</button></a></h4>
    ...
    <tbody>
      	...
      	<tr>
      		<td>${food.id}</td>
      		<td>${food.name}</td>
      		<td>${food.category.catName}</td>
      		<td>${food.price}</td>
      		<td> <img src="${food.image}" style="max-width:80px"></td>
      		<td>${food.description}</td>
      		<td class="btn-group" style="width: 100%">
      			<a href="menu-delete?id=${food.id}"  style="border-bottom-color:black; background-color:orange;" class="btn" /><i class="fa fa-trash"></i></button>
      			<a href="menu-form-update?id=${food.id}"  style="border-bottom-color:black; background-color:aqua;" class="btn" /><i class="fa fa-edit"></i></button>
      			</div> 
      		</td>
      	</tr>
