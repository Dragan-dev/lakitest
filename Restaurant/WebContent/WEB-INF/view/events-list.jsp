  ...
  <div class="content-wrapper">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <h4 align="right"><a href="chef-form"><button style="border-bottom-color: black; background: aqua;" class="button1" >Add new  event</button></a></h4>
    ...
    <tbody>
      	...
      	<tr>
      		...
      		<td><img style="max-width: 150px" alt="" src="${events.picture}"> </td>
      		<td>${events.description}</td>	
      		
      		<td class="btn-group" style="width: 100%">	
      		      
      		    <a href="events-form-update?id=${events.id}"  style="border-bottom-color:black; background-color:aqua;" class="btn" /><i class="fa fa-edit"></i></button>
      			<a href="events-delete?id=${events.id}"  style="border-color:black; background-color:orange;" class="btn" /><i class="fa fa-trash"></i></button>
