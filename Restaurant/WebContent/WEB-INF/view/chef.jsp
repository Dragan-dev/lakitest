  ...
  <div class="content-wrapper">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <h4 align="right"><a href="chef-form"><button style="border-bottom-color: black; background: aqua;" class="button1" >Add new chef</button></a></h4>
    ...
    <tbody>
      	...
      	<tr>
      		<td>${chef.id}</td>
      		<td>${chef.name}</td>
      		<td><img style="max-width: 150px" alt="" src="${chef.picture}"> </td>
      		<td>${chef.rank}</td>	
      		
      		<td class="btn-group" style="width: 100%">	
      		      
      		    <a href="chef-form-update?id=${chef.id}"  style="border-bottom-color:black; background-color:aqua;" class="btn" /><i class="fa fa-edit"></i></button>
      			<a href="chef-delete?id=${chef.id}"  style="border-color:black; background-color:orange;" class="btn" /><i class="fa fa-trash"></i></button>
