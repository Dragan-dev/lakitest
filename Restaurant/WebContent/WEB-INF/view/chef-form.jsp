          ...
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Chef form</h3>
              </div>
              <form:form action="chef-save" modelAttribute="chef" role="form">
<%--                 <form:hidden path="id"/>  --%>
                <div class="card-body">
                  <div class="form-group">
                    <label>Chef name</label>
                    <form:input type="text" class="form-control" placeholder="Enter chef name" path="name"/>
                  	<form:errors path="name" cssClass="text-danger"/>
                  </div>
                
                 <div class="form-group"> 
                     <label>Chef rank</label> 
                     <form:input type="text" class="form-control" placeholder="Enter chef rank" path="rank"/> 
                   	<form:errors path="rank" cssClass="text-danger"/> 
                 </div> 
                  
                  <div class="form-group">
                    <label>Chef picture</label>
                    <form:input type="text" class="form-control" placeholder="Enter image URL" path="picture"/>
                ...
                <div class="card-footer">
                  ...
                  <a href="chef-update-cancel" class="btn btn-outline-secondary">Cancel</a>
 				</div>
              </div>
                </div>
            </div>
